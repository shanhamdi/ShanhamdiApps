...
public class RumahSakitZainab extends ListActivity {
    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")) {
                String nomortel = "tel:0761-75667";
                a = new Intent(Intent.ACTION_DIAL, Uri.parse(nomortel));

            } else if (pilihan.equals("SMS Center")) {
                String smsText = "(RS Zainab) Ikhsanul Hamdi /L";
                a = new Intent(Intent.ACTION_VIEW);
                a.setData(Uri.parse("sms:085188211199"));
                ...
                a.putExtra(SearchManager.QUERY, "Rumah Sakit Zainab");
            }
